...
echo "<html>";
echo "<head>";
echo "<title>Edit Supply Info</title>";
echo "</head>";
echo '<body>';
echo '<form name="form1" action="'.$edit_link.'" method="post">';
echo '<input type="hidden" name="edit_supply_form" value="posted">';
echo '<input type="hidden" name="item_id" value="'.$item_id.'">';

echo '<b><span style="color: #3366FF;">Edit Entry</span></b> ';
echo '( Supply ID : <span style="color: rgb(235, 0, 0);"><b>'.$item_id.'</b></span>)';
...
<input type="text" name="model" size="20" value="'.$model.'"></td> ';
